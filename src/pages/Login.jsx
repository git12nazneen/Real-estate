...
const Login = () => {
	...
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm">
			<svg onClick={handleGoogleSignIn} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
		...
		<button aria-label="Log in with GitHub" className="p-3 rounded-sm">
			<svg onClick={handleGithubLogin} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
