...
import png from '../assets/BrivIN logo for website transparent-06-06.png'
...
const Footer = () => {
    return (
       ...
       <div className='text-center lg:text-left'>
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3 pt-9">
			<div className="space-y-3">
				<h3 className="tracking-wide font-bold text-xl uppercase text-gray-50">Explore</h3>
				<ul className="space-y-5">
					<li className='font-light text-red-100'>
						<a rel="noopener noreferrer " href="#">Meet Our team</a>
					</li>
					<li className='font-light text-red-100'>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide font-bold text-xl  uppercase text-gray-50">Categories</h3>
				<ul className="space-y-5">
                    <li className='font-light text-red-100'>
                    ...
                    <li className='font-light text-red-100'>
						<a rel="noopener noreferrer " href="#">New Projects</a>
					</li>
                    <li className='font-light text-red-100'>
			...
			<div className="space-y-3 w-full sm:col-span-1 col-span-2">
				...
				<ul className="space-y-5">
					<li className='font-light text-red-100'>
						<a rel="noopener noreferrer" href="#">Subscribe for our latest resources</a>
					</li>
				</ul>
